# callcat.ai web-call embed — user guide (app.vocadesk.com)
...
You need:
- A **callcat.ai operator account** (log in at https://app.vocadesk.com).
...
```html
<script
  src="https://cdn.vocadesk.com/embed/v0.3.7/vocadesk.min.js"
  integrity="sha384-saHP/HU2OeJkKxQtRHIHO/JmE4mtQFpZVPT/JBAH7dTe54kpQiWblFkGugSX/LRv"
...
1. Go to **Calls** in the callcat.ai dashboard at https://app.vocadesk.com.
